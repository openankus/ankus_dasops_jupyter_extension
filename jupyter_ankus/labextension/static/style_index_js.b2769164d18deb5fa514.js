...
.ankus-icon-btn:disabled {
    ...
    cursor: auto;
}`, "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;;;;CAIC;;AAED;IACI,8BAA8B;IAC9B,8BAA8B;AAClC;;AAEA;IACI,WAAW;IACX,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,mBAAmB;IACnB,aAAa;AACjB;;AAEA;IACI,wBAAwB;IACxB,aAAa;IACb,0BAA0B;IAC1B,eAAe;IACf,wBAAwB;IACxB,WAAW;IACX,mBAAmB;IACnB,aAAa;IACb,uBAAuB;AAC3B;AACA;IACI,yBAAyB;IACzB,eAAe;AACnB;;AAEA;IACI,yCAAyC;IACzC,+BAA+B;AACnC;;AAEA;IACI,iCAAiC;IACjC,eAAe;IACf,gBAAgB;AACpB;;AAEA;IACI,6BAA6B;IAC7B,iCAAiC;IACjC,YAAY;IACZ,UAAU;IACV,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,eAAe;AACnB;AACA;IACI,yCAAyC;AAC7C;AACA;IACI,iCAAiC;IACjC,YAAY;AAChB","sourcesContent":["/*\n    See the JupyterLab Developer Guide for useful CSS Patterns:\n\n    https://jupyterlab.readthedocs.io/en/stable/developer/css.html\n*/\n\n:root {\n    --ankus-control-color: #4682B4;\n    --ankus-disable-color: #c0c0c0;\n}\n\n.ankus-loading-container {\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.align-vt-center {\n    align-items: center;\n    display: flex;\n}\n\n.ankus-completer-new-term {\n    width : calc(100% - 4px);\n    height : 25px;\n    border : 1px solid #D3D3D3;\n    color : #000080;\n    background-color : white;\n    margin: 1px;\n    align-items: center;\n    display: flex; \n    justify-content: center; \n}  \n.ankus-completer-new-term:hover {\n    background-color: #DCDCDC;\n    cursor: pointer;\n}\n\n.ankus-container {\n    background-color: var(--jp-layout-color1);\n    color: var(--jp-ui-font-color1);\n}\n\n.ankus-ui-text {\n    color: var(--ankus-control-color);\n    font-size: 14px;\n    font-weight: 500;\n}\n\n.ankus-icon-btn {\n    background-color: transparent;\n    color: var(--ankus-control-color);\n    border: none;\n    padding: 0;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    cursor: pointer;\n}\n.ankus-icon-btn:hover {\n    background-color: var(--jp-layout-color2);\n}\n.ankus-icon-btn:disabled {\n    color: var(--ankus-disable-color);\n    cursor: auto;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.b2769164d18deb5fa514.js.map
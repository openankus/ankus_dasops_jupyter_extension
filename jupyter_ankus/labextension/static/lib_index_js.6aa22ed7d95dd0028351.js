            ...
            if (_ankusCommon__WEBPACK_IMPORTED_MODULE_2__.Ankus.loginToken !== undefined &&
                ...
                if (token !== undefined) {
                    try {
                        ...
                        noti.innerText = 'Searching ' + token.value + ' in Dictionary';
                        noti.style.left = p.right + 'px';
                        noti.style.top = p.bottom + 'px';
...
//# sourceMappingURL=lib_index_js.6aa22ed7d95dd0028351.js.map
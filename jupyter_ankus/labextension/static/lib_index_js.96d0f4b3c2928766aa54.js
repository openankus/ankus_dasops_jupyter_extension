   ...
   */
    ...
    app.commands.addCommand(CommandID.stdtrmAutoComplete.id, {
        ...
        execute: async () => {
            if (_ankusCommon__WEBPACK_IMPORTED_MODULE_2__.Ankus.loginToken !== undefined &&
                ...
                _ankusCommon__WEBPACK_IMPORTED_MODULE_2__.Ankus.activeNotebook.parent.parent.parent.parent.parent.parent.node.appendChild(noti);
                try {
    ...
    app.commands.addCommand(CommandID.selectCodeItem.id, {
        ...
        execute: async () => {
            ...
            try {
                //show auto complete menu
                const mn = await _ankusCommon__WEBPACK_IMPORTED_MODULE_2__.ShareCode.completerMenu(tkn, p.left, p.bottom);
                noti.remove();
                if (mn) {
                    //focus out
                    mn.onblur = ev => {
...
class StandardTerm extends (react__WEBPACK_IMPORTED_MODULE_1___default().Component) {
    constructor(props) {
        ...
        this.searchTerm = async (orderCol, asc) => {
            ...
            this.setState({ loading: true });
            //search term
            const lst = await _ankusCommon__WEBPACK_IMPORTED_MODULE_5__.StandardTermPart.searchWords(this.state.searchOption, this.state.keyword, orderCol, asc, this.state.category);
            if (lst !== null) {
                this._termList = lst;
                this.setState({
    ...
    constructor(props) {
        ...
        this.loadWords = async (catid, keyword) => {
            ...
            if (catid !== 0) {
                ...
                const lst = await _ankusCommon__WEBPACK_IMPORTED_MODULE_7__.StandardTermPart.searchWords(_ankusCommon__WEBPACK_IMPORTED_MODULE_7__.StandardTermPart.Field.engName, keyword, _ankusCommon__WEBPACK_IMPORTED_MODULE_7__.StandardTermPart.Field.engName, true, catid);
                this.setState({
...
//# sourceMappingURL=lib_index_js.96d0f4b3c2928766aa54.js.map
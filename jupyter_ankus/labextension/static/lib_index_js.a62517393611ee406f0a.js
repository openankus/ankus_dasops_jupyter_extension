            ...
            if (_ankusCommon__WEBPACK_IMPORTED_MODULE_2__.Ankus.loginToken !== undefined &&
                ...
                if (token !== undefined) {
                    try {
                        ...
                        noti.innerText = 'Searching for ' + token.value + ' in Dictionary';
                        noti.style.left = p.right + 5 + 'px';
                        noti.style.top = p.top + 'px';
                        noti.style.position = 'fixed';
                        noti.style.zIndex = '99';
                        noti.style.opacity = '0.8';
                        noti.style.color = 'var(--jp-info-color0)';
...
//# sourceMappingURL=lib_index_js.a62517393611ee406f0a.js.map
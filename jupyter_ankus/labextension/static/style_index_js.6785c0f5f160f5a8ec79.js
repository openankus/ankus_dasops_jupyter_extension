...
/* .ankus-code-menu .lm-Menu-itemIcon > svg {
    position: relative;
    top: 3px;
} */`, "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;;;;CAIC;;AAED;IACI,8BAA8B;IAC9B,8BAA8B;AAClC;;AAEA;IACI,WAAW;IACX,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,mBAAmB;IACnB,aAAa;AACjB;;AAEA;IACI,wBAAwB;IACxB,aAAa;IACb,0BAA0B;IAC1B,eAAe;IACf,wBAAwB;IACxB,WAAW;IACX,mBAAmB;IACnB,aAAa;IACb,uBAAuB;AAC3B;AACA;IACI,yBAAyB;IACzB,eAAe;AACnB;;AAEA;IACI,yCAAyC;IACzC,+BAA+B;AACnC;;AAEA;IACI,iCAAiC;IACjC,eAAe;IACf,gBAAgB;AACpB;;AAEA,gBAAgB;AAChB;IACI,6BAA6B;IAC7B,iCAAiC;IACjC,YAAY;IACZ,UAAU;IACV,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,eAAe;AACnB;AACA;IACI,yCAAyC;AAC7C;AACA;IACI,iCAAiC;IACjC,YAAY;AAChB;;AAEA;IACI,eAAe;IACf,WAAW;IACX,yCAAyC;IACzC,yCAAyC;IACzC,+BAA+B;IAC/B,gBAAgB;IAChB,gBAAgB;IAChB,UAAU;IACV,sBAAsB;AAC1B;AACA;IACI,UAAU;IACV,aAAa;AACjB;AACA;IACI,iBAAiB;AACrB;AACA,0BAA0B;AAC1B;IACI,eAAe;IACf,gBAAgB;IAChB,gBAAgB;IAChB,mBAAmB;IACnB,uBAAuB;IACvB,+BAA+B;AACnC;AACA,oBAAoB;AACpB;IACI,yCAAyC;AAC7C;AACA,qBAAqB;AACrB;IACI,wCAAwC;IACxC,uCAAuC;AAC3C;;AAEA,0BAA0B;AAC1B;IACI,6BAA6B;AACjC;AACA;IACI,uCAAuC;AAC3C;;AAEA;IACI,qCAAqC;AACzC;;AAEA;;;GAGG","sourcesContent":["/*\n    See the JupyterLab Developer Guide for useful CSS Patterns:\n\n    https://jupyterlab.readthedocs.io/en/stable/developer/css.html\n*/\n\n:root {\n    --ankus-control-color: #4682B4;\n    --ankus-disable-color: #c0c0c0;\n}\n\n.ankus-loading-container {\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.align-vt-center {\n    align-items: center;\n    display: flex;\n}\n\n.ankus-completer-new-term {\n    width : calc(100% - 4px);\n    height : 25px;\n    border : 1px solid #D3D3D3;\n    color : #000080;\n    background-color : white;\n    margin: 1px;\n    align-items: center;\n    display: flex; \n    justify-content: center; \n}  \n.ankus-completer-new-term:hover {\n    background-color: #DCDCDC;\n    cursor: pointer;\n}\n\n.ankus-container {\n    background-color: var(--jp-layout-color1);\n    color: var(--jp-ui-font-color1);\n}\n\n.ankus-ui-text {\n    color: var(--ankus-control-color);\n    font-size: 14px;\n    font-weight: 500;\n}\n\n/* icon button */\n.ankus-icon-btn {\n    background-color: transparent;\n    color: var(--ankus-control-color);\n    border: none;\n    padding: 0;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    cursor: pointer;\n}\n.ankus-icon-btn:hover {\n    background-color: var(--jp-layout-color2);\n}\n.ankus-icon-btn:disabled {\n    color: var(--ankus-disable-color);\n    cursor: auto;\n}\n\n.ankus-autocomplet-menu {\n    position: fixed;\n    z-index: 99;\n    background-color: var(--jp-layout-color0); \n    border: 1px solid var(--jp-border-color1);\n    color: var(--jp-ui-font-color1);\n    min-width: 150px;\n    max-width: 400px;\n    padding: 0;\n    /* overflow-y: auto; */\n}\n.ankus-autocomplet-menu dl {\n    padding: 0;\n    margin: 3px 0;\n}\n.ankus-autocomplet-menu dl>dt {\n    padding: 3px 10px;\n}\n/* menu item description */\n.ankus-autocomplet-menu dl dd {\n    font-size: 11px;\n    max-height: 30px;\n    overflow: hidden;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    color: var(--jp-ui-font-color2);\n}\n/* hover menu item */\n.ankus-autocomplet-menu dl>dt:hover {\n    background-color: var(--jp-layout-color2);\n}\n/* select menu item */\n.ankus-autocomplet-menu .sel-menu {\n    background-color: var(--jp-brand-color1);\n    color: var(--jp-ui-inverse-font-color1);\n}\n\n/* menu item - code name */\n.ankus-autocomplet-menu dl>dt>span:nth-child(1) {\n    color: var(--jp-brand-color1);\n}\n.ankus-autocomplet-menu .sel-menu>span:nth-child(1) {\n    color: var(--jp-ui-inverse-font-color0);\n}\n\n.ankus-editor-icon .cls-1 {\n    fill: var(--jp-inverse-layout-color2);\n}\n\n/* .ankus-code-menu .lm-Menu-itemIcon > svg {\n    position: relative;\n    top: 3px;\n} */"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.6785c0f5f160f5a8ec79.js.map
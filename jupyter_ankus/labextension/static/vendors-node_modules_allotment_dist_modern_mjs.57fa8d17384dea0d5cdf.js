...
const ke = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(({
  ...
  const x = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null),
    V = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)([]),
    O = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(new Map()),
    N = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null),
    T = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(new Map()),
    C = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(new Y()),
    F = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)([]),
    [$, B] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(!1);
   true && p && console.warn("Prop sizes is deprecated. Please use defaultSizes instead.");
  const R = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(o).filter((react__WEBPACK_IMPORTED_MODULE_0___default().isValidElement)), [o]),
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useImperativeHandle)(I, () => ({
  ...
  }, [R, $, h, l, y]), (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (!$) {
      ...
      (_N$current13 = N.current) != null && _N$current13.layout(b ? e : t), C.current.setSize(b ? e : t), B(!0);
    }
    ...
    const i = t.key;
    return "Allotment.Pane" === t.type.displayName ? (O.current.set(i, t.props), react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(t, {
      key: i,
      ref: e => {
        const n = t.ref;
...
//# sourceMappingURL=vendors-node_modules_allotment_dist_modern_mjs.57fa8d17384dea0d5cdf.js.map
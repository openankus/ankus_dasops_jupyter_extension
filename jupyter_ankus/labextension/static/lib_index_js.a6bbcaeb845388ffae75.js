...
(function (ShareCode) {
    ...
    async function completerMenu(keyword, x, y) {
        ...
        busy.innerText = 'search code...';
        menu.append(busy);
        Ankus.activeNotebook.parent.parent.parent.parent.parent.parent.node.appendChild(menu);
        let selidx;
...
//# sourceMappingURL=lib_index_js.a6bbcaeb845388ffae75.js.map